...
module SFL
  module Compiler
    ...
    # Raised when a document produces zero clauses — there is nothing to
    # aggregate, so a report would be all defaults rather than findings.
    ...
    class Configuration
      attr_accessor :database_url, :spacy_model, :dspy_provider,
        ...
        :ollama_base_url, :embedding_model, :vision_model
      ...
      def initialize
        ...
        @vision_model = ENV.fetch("VISION_MODEL", nil)
      end
...
loader.collapse("#{__dir__}/compiler/workflows")
