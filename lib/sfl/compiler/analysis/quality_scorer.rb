...
module SFL
  module Compiler
    module Analysis
      ...
      #
      # Weights reflect that annotation reliability and content certainty matter
      # most for KB decisions, while freshness is a weak signal (stale but
      # high-modality reference content is still worth keeping).
      class QualityScorer
