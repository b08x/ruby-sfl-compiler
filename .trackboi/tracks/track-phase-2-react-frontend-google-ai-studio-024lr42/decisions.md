...
## [accepted] Phase 3 opened — Falcon-wiring card moved to doing

User explicitly directed work to start on "Strip ConvoWorkbench's client-side data/LLM layer, wire GraphContext to Falcon API" (2026-07-03), superseding the 2026-07-02 "Defer to Phase 3" decision for this card. Phase 3 is now open. The other 4 backlog cards in this track remain in backlog until picked up individually — this decision opens the gate, it doesn't bulk-start the track.
