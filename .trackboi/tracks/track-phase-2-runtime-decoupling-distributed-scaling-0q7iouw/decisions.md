...
## [accepted] Removed spaCy micro service from scope

Will re-eval in future if it becomes apparently necessary. spaCy python library and models installed with via extconf
